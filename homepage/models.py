...
class TaskAnswer(models.Model):
    ...
    answer_describe = models.CharField(max_length=500, blank=True, null=True)
    answer_insufficient = models.CharField(max_length=500, blank=True, null=True)
    status = models.IntegerField(blank=True, null=True)
    up_data = models.DateField(blank=True, null=True,auto_now_add=True)
